...
%This method can be extended to accommodate both bitwise operators as well as addition and
%subtraction by extending the tables with a carry-out value. The following example shows
%that $x \oplus y = x - y \mid x$ is not associative:
